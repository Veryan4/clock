...
class HomeComponent extends LitElement {
  ...
  latitude = import.meta.env.VITE_DEFAULT_LATITUDE as string
  longitude = import.meta.env.VITE_DEFAULT_LONGITUDE as string
  ...
  getLocation() {
    if (navigator.geolocation && import.meta.env.VITE_IS_LOCATION_STATIC != "true") {

...
export class ClockComponent extends LitElement {
  ...
  @property({type: Date})
  timeZonedDate = new Date(); // defaults to browser's timezone;
  ...
  const theme = {
    ...
    '--rim-color': this.rimColor,
    '--dot-color': this.dotColor,
    '--seconds-color': this.secondsColor
  };
  return html`
    <div class="clock-wrap" style=${styleMap(theme)}>
        <div class="clock">
            <div class="dot"></div>
  ...
  async connectedCallback() {
    ...
    const deg = 6;
    const timezone = this.timeZonedDate.getUTCDate();

    this.timeInterval = setInterval(() => {
      const day = new Date();
      day.setUTCDate(timezone);
  ...
  renderClockFace() {
    return svg`<svg version="1.1" class="clock-dial" 
        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        viewBox="0 0 288.001 295.276">
      <g>
